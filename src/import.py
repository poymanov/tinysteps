...
teachers_data = [
    {
        ...
        'price': 900,
        'goals': json.dumps(['travel', 'relocate', 'study']),
        'free': free_data
    },
    {
        'name': 'Lee P',
        ...
        'price': 1200,
        'goals': json.dumps(['relocate', 'study']),
        'free': free_data
    },
    {
        'name': 'Felix A',
    ...
    },
    {
        ...
        'rating': 4.5,
        'price': 1200,
        'goals': json.dumps(['travel', 'study', 'relocate']),
        'free': free_data
    },
    {
        'name': 'Mr. Mark',
    ...
    },
    {
        ...
        'rating': 5,
        'price': 1700,
        'goals': json.dumps(['relocate', 'work']),
        'free': free_data
    },
    {
        'name': 'Seeta Y.',
    ...
    },
    {
        ...
        'rating': 4.7,
        'price': 1100,
        'goals': json.dumps(['travel', 'study', 'work']),
        'free': free_data
    },
    {
        'name': 'Andrew G',
        ...
        'rating': 4.2,
        'price': 900,
        'goals': json.dumps(['travel', 'work']),
        'free': free_data
    },
]

for teacher_item in teachers_data:
    db.session.add(Teacher(**teacher_item))
